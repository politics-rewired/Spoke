...
const dialogBodyForStep = (step) => {
  switch (step) {
    case EscalateStep.FAQ:
      return <p>Have you checked the <a href="https://brnsndrs.com/textfaq" target="_blank">FAQ</a>?</p>
  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <p>Escalation is meant for situations where you have exhausted all available help resources and still do not know how to respond.</p>
