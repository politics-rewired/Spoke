...
import { Campaign, useSearchCampaignsNewLazyQuery } from "@spoke/spoke-codegen";
...
export const useFetchAllCampaigns = (organizationId: string) => {
  const [getCampaigns] = useSearchCampaignsNewLazyQuery({
