...
const Registration10DLCWarningText: React.FC = () => (
  <>
    <p>
      ...
      sending without registering for 10DLC, but you will be charged at our
      higher unregistered sending prices and may see lower message
      deliverability starting on July 1st.
    </p>
    <p>
